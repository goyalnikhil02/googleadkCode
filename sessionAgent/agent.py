...
async def main():
    ...
    support_agent = Agent(
        ...
        output_key="state",
        instruction="You are a friendly customer support agent for Nikhil Store. "
                    "Customer: {customer_name}. "
                    "Their favorite category is {favorite_category}."
                    "Recent order: {recent_order}. "
                    "Loyalty points: {loyalty_points}.",
    )

    # Create session
    APP_NAME = "Nikhil_Store"
    CUSTOMER_ID = "nikhilgg"
